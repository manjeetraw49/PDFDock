...
def make_smartlink_banner(position="top"):
    if position == "top":
        return """
  <!-- Top Monetag SmartLink Sponsored Banner -->
  <aside class="ad-container ad-banner-top" id="ad-top" aria-label="Sponsored Recommendation">
    <a href="https://omg10.com/4/11833285" target="_blank" rel="noopener sponsored" class="smartlink-banner-link" title="Explore Partner Cloud Services">
      <div class="smartlink-card">
        <span class="smartlink-badge">Sponsored</span>
        <div class="smartlink-icon">
        ...
        <div class="smartlink-info">
          <span class="smartlink-title">⚡ Fast Cloud Storage &amp; Secure File Transfer</span>
          <span class="smartlink-desc">Free high-speed file storage, document backup &amp; instant sharing offers.</span>
        </div>
        <span class="smartlink-action">Explore Deals &rarr;</span>
      </div>
    </a>
  </aside>
"""
        ...
        return """
    <!-- Mid Monetag SmartLink Sponsored Banner -->
    <aside class="ad-container ad-banner-mid" id="ad-mid" aria-label="Sponsored Recommendation">
      <a href="https://omg10.com/4/11833285" target="_blank" rel="noopener sponsored" class="smartlink-banner-link" title="Special Partner Deals">
        <div class="smartlink-card">
          <span class="smartlink-badge">Partner Offer</span>
          <div class="smartlink-icon">
          ...
          <div class="smartlink-info">
            <span class="smartlink-title">📁 Premium Productivity Apps &amp; Cloud Tools</span>
            <span class="smartlink-desc">Special offers on document utilities, cloud backup, and PDF software.</span>
          </div>
          <span class="smartlink-action">Get Access &rarr;</span>
        </div>
      </a>
    </aside>
"""
        ...
        return """
    <!-- Bottom Monetag SmartLink Sponsored Banner -->
    <aside class="ad-container ad-banner-bottom" id="ad-bottom" aria-label="Sponsored Recommendation">
      <a href="https://omg10.com/4/11833285" target="_blank" rel="noopener sponsored" class="smartlink-banner-link" title="Explore Recommended Partner Services">
        <div class="smartlink-card">
          <span class="smartlink-badge">Recommended</span>
          <div class="smartlink-icon">
          ...
          <div class="smartlink-info">
            <span class="smartlink-title">🚀 Fast File Archiving &amp; Document Solutions</span>
            <span class="smartlink-desc">Explore verified partners for secure file compression, cloud tools &amp; storage.</span>
          </div>
          <span class="smartlink-action">Learn More &rarr;</span>
        </div>
      </a>
    </aside>
"""
...
def make_download_recommendation():
    return """
        <div class="sponsored-recommendation-box">
          <span class="sponsored-badge">Sponsored Recommendation</span>
          <br>
          <a href="https://omg10.com/4/11833285" target="_blank" rel="noopener sponsored" class="sponsored-recommendation-link">
            <span class="sponsored-link-icon">⚡</span>
            <span class="sponsored-link-text">Need fast, unlimited cloud storage for your files? <strong>Explore Free Cloud Partner &rarr;</strong></span>
          </a>
        </div>
"""
